<script lang="ts">
  ...
  $effect(() => {
    if (authState.user) {
      ...
      client.mutation(api.users.store, {
        uid,
        email: email || "",
  ...
  const schemaData = {
    ...
    "description": "AI-Powered Financial Auditing and Ledger Management Platform for Nigeria. Enterprise-grade compliance and real-time intelligence.",
...
<svelte:head>
  ...
  <meta name="description" content="Transform your financial auditing with AI. Secure, enterprise-grade ledger management and real-time compliance for Nigerian businesses. Start your free trial today!" />
